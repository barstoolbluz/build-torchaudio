# TorchAudio with PyTorch 2.10.0 for NVIDIA Ampere DC (SM80: A100, A30) + AVX-512 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm80-avx512-nomagma
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm80-avx512-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_0-sm80-avx512-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      export CFLAGS="${nixpkgs_pinned.lib.concatStringsSep " " cpuFlags} $CFLAGS"
      export MAX_JOBS=32
      echo "GPU Target: ${gpuArchSM} (Ampere DC: A100, A30) | CPU: AVX-512 | CUDA: 13.0"
    '';
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA A100/A30 (SM80, Ampere DC) + AVX-512 with PyTorch 2.10.0 (no MAGMA)";
