# TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + AVX-512
# Package name: torchaudio-python313-cuda12_9-sm90-avx512
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + AVX-512";
