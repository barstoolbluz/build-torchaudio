# TorchAudio optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 BF16
# Package name: torchaudio-python313-cuda12_9-sm86-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm86-avx512bf16";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: 8.6 (Ampere RTX 30-series)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Ampere RTX 30-series (SM86) + AVX-512 BF16";
