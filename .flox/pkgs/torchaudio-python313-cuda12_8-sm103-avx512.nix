# TorchAudio optimized for NVIDIA Blackwell B300 (SM103) + AVX-512
# Package name: torchaudio-python313-cuda12_8-sm103-avx512
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm103-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Blackwell B300 (SM103) + AVX-512";
      longDescription = ''
        ...
        Ensure pytorch-python313-cuda12_8-sm103-avx512 is installed.
      '';
