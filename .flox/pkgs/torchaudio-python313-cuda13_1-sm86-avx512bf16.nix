# TorchAudio with PyTorch 2.10.0 for NVIDIA Ampere (SM86: RTX 3090, A40) + AVX-512 BF16
# Package name: torchaudio-python313-cuda13_1-sm86-avx512bf16
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm86-avx512bf16";
    patches = [];
    ninjaFlags = [ "-j32" ];
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_1-sm86-avx512bf16";
    ...
    '';
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 3090/A40 (SM86, Ampere) + AVX-512 BF16 with PyTorch 2.10.0";
