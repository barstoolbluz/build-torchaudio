# TorchAudio with PyTorch 2.10.0 for NVIDIA Hopper (SM90: H100, L40S) + AVX-512 VNNI (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm90-avx512vnni-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm90-avx512vnni-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm90-avx512vnni-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA H100/L40S (SM90, Hopper) + AVX-512 VNNI with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
