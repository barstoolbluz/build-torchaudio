# TorchAudio with PyTorch 2.10.0 for NVIDIA Rubin (Future) (SM120) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm120-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM120 (NVIDIA Rubin (Future) - Automotive/Edge)
  gpuArchSM = "12.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm120-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm120-armv8_2-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (NVIDIA Rubin (Future))"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Rubin (Future) (SM120) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA Rubin (Future) (SM120) - Automotive/Edge AI
        ...
        - GPU: NVIDIA Rubin (Future), Orin+ (Automotive/Embedded platforms)
