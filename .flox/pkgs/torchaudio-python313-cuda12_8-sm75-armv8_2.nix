...
# Package name: torchaudio-python313-cuda12_8-sm75-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm75-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Turing T4/RTX 2080 Ti (SM75) + ARMv8.2";
      longDescription = ''
        ...
        Optimized for ARM-based platforms with Turing GPUs.
      '';
