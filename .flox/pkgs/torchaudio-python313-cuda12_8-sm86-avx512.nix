# TorchAudio optimized for NVIDIA Ampere RTX 3090/A40 (SM86) + AVX-512
# Package name: torchaudio-python313-cuda12_8-sm86-avx512
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm86-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Ampere RTX 3090/A40 (SM86) + AVX-512";
      longDescription = ''
