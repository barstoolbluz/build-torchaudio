# TorchAudio with PyTorch 2.10.0 for NVIDIA RTX 4090/L40 (SM89) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm89-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM89 (NVIDIA DRIVE Thor - Automotive/Edge)
  gpuArchSM = "8.9";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm89-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm89-armv8_2-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 4090/L40 (SM89) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA RTX 4090/L40 (SM89) - Automotive/Edge AI
