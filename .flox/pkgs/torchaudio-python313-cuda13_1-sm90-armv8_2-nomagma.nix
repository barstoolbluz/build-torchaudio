# TorchAudio with PyTorch 2.10.0 for NVIDIA H100 (Hopper) (SM90) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm90-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM90 (NVIDIA H100 (Hopper) - Automotive/Edge)
  gpuArchSM = "9.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm90-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm90-armv8_2-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (NVIDIA H100 (Hopper))"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA H100 (Hopper) (SM90) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA H100 (Hopper) (SM90) - Automotive/Edge AI
        ...
        - GPU: NVIDIA H100 (Hopper), Orin+ (Automotive/Embedded platforms)
