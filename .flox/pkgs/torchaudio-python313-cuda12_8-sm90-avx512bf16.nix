# TorchAudio optimized for NVIDIA Hopper H100/L40S (SM90) + AVX-512 BF16
# Package name: torchaudio-python313-cuda12_8-sm90-avx512bf16
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm90-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Hopper H100/L40S (SM90) + AVX-512 BF16";
      longDescription = ''
        ...
        BF16 acceleration for ML training workloads on Hopper.
      '';
