...
# Package name: torchaudio-python313-cuda12_8-sm100-avx512
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm100-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Blackwell B100/B200 (SM100) + AVX-512";
      longDescription = ''
