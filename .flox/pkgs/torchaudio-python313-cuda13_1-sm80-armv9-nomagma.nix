# TorchAudio with PyTorch 2.10.0 for NVIDIA A100 (Ampere) (SM80) + ARMv9 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm80-armv9-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm80-armv9-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm80-armv9-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA A100 (Ampere) (SM80) + ARMv9 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
