# TorchAudio optimized for NVIDIA Turing T4/RTX 2080 Ti (SM75) + ARMv9
# Package name: torchaudio-python313-cuda12_8-sm75-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm75-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Turing T4/RTX 2080 Ti (SM75) + ARMv9";
      longDescription = ''
        ...
        Maximum performance for next-gen ARM with Turing GPUs.
      '';
