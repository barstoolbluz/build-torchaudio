# TorchAudio with PyTorch 2.10.0 for NVIDIA Automotive (SM110: DRIVE Thor) + AVX2
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm110-avx2";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA DRIVE Thor (SM110, Automotive) + AVX2 with PyTorch 2.10.0";
      longDescription = ''
