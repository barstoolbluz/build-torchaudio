# TorchAudio with PyTorch 2.10.0 for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm100-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM100 (NVIDIA B100 (Blackwell) - Automotive/Edge)
  gpuArchSM = "10.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm100-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm100-armv8_2-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (NVIDIA B100 (Blackwell))"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA B100 (Blackwell) (SM100) - Automotive/Edge AI
        ...
        - GPU: NVIDIA B100 (Blackwell), Orin+ (Automotive/Embedded platforms)
