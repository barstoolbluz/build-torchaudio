# TorchAudio with PyTorch 2.10.0 for NVIDIA RTX 3090/A40 (SM86) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm86-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM86 (NVIDIA DRIVE Thor - Automotive/Edge)
  gpuArchSM = "8.6";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm86-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm86-armv8_2-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 3090/A40 (SM86) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA RTX 3090/A40 (SM86) - Automotive/Edge AI
