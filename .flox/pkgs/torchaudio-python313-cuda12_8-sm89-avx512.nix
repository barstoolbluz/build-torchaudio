# TorchAudio optimized for NVIDIA Ada Lovelace RTX 4090/L40 (SM89) + AVX-512
# Package name: torchaudio-python313-cuda12_8-sm89-avx512
...
in
  (python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Ada Lovelace RTX 4090/L40 (SM89) + AVX-512";
      longDescription = ''
        ...
        Ensure pytorch-python313-cuda12_8-sm89-avx512 is installed.
      '';
