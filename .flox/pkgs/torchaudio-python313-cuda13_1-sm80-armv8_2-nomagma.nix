# TorchAudio with PyTorch 2.10.0 for NVIDIA A100 (Ampere) (SM80) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm80-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM80 (NVIDIA A100 (Ampere) - Automotive/Edge)
  gpuArchSM = "8.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm80-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm80-armv8_2-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (NVIDIA A100 (Ampere))"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA A100 (Ampere) (SM80) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA A100 (Ampere) (SM80) - Automotive/Edge AI
        ...
        - GPU: NVIDIA A100 (Ampere), Orin+ (Automotive/Embedded platforms)
