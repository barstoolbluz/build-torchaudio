...
# Package name: torchaudio-python313-cuda12_8-sm121-armv9
...
in
  ...
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm121-armv9";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        Ensure pytorch-python313-cuda12_8-sm121-armv9 is installed.
