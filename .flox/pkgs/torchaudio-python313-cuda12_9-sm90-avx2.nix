# TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + AVX2
# Package name: torchaudio-python313-cuda12_9-sm90-avx2
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm90-avx2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + AVX2";
