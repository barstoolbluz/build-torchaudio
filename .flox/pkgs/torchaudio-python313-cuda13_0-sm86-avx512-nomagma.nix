...
# Package name: torchaudio-python313-cuda13_0-sm86-avx512-nomagma
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_0-sm86-avx512-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      export CFLAGS="${nixpkgs_pinned.lib.concatStringsSep " " cpuFlags} $CFLAGS"
      export MAX_JOBS=32
      echo "GPU Target: ${gpuArchSM} (Ampere: RTX 3090, A40) | CPU: AVX-512 | CUDA: 13.0"
    '';
    meta = oldAttrs.meta // {
