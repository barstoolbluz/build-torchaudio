# TorchAudio with PyTorch 2.10.0 for NVIDIA T4/RTX 2080 Ti (SM75) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm75-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM75 (NVIDIA DRIVE Thor - Automotive/Edge)
  gpuArchSM = "7.5";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm75-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm75-armv8_2-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA T4/RTX 2080 Ti (SM75) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA T4/RTX 2080 Ti (SM75) - Automotive/Edge AI
