# TorchAudio optimized for NVIDIA Hopper H100/L40S (SM90) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda12_8-sm90-avx512vnni
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm90-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      ...
      longDescription = ''
        ...
        VNNI acceleration for INT8 inference on Hopper.
      '';
