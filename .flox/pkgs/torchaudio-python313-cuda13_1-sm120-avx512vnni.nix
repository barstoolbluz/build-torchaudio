# TorchAudio with PyTorch 2.10.0 for NVIDIA Blackwell (SM120: RTX 5090) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda13_1-sm120-avx512vnni
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm120-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm120-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 5090 (SM120, Blackwell) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
