...
# Package name: torchaudio-python313-cuda12_9-sm80-armv9
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm80-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Ampere A100/A30 (SM80) + ARMv9";
