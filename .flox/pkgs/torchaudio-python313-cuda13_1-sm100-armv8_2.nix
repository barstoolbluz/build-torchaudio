# TorchAudio with PyTorch 2.10.0 for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2
# Package name: torchaudio-python313-cuda13_1-sm100-armv8_2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm100-armv8_2";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm100-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B100 (Blackwell) (SM100) + ARMv8.2 with PyTorch 2.10.0";
      longDescription = ''
