# TorchAudio with PyTorch 2.10.0 for NVIDIA Ada Lovelace (SM89: RTX 4090) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda13_1-sm89-avx512vnni
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm89-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm89-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 4090 (SM89, Ada Lovelace) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
