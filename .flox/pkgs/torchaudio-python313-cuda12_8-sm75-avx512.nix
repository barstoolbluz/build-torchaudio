# TorchAudio optimized for NVIDIA Turing T4/RTX 2080 Ti (SM75) + AVX-512
# Package name: torchaudio-python313-cuda12_8-sm75-avx512
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm75-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Turing T4/RTX 2080 Ti (SM75) + AVX-512";
      longDescription = ''
        ...
        Ensure pytorch-python313-cuda12_8-sm75-avx512 is installed.
      '';
