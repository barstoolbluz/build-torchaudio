...
# Package name: torchaudio-python313-cuda12_9-sm75-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm75-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Turing T4/RTX 2080 Ti (SM75) + AVX-512 BF16";
