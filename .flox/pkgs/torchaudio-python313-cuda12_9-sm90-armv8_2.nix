# TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + ARMv8.2
# Package name: torchaudio-python313-cuda12_9-sm90-armv8_2
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm90-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Hopper H100/H200 (SM90) + ARMv8.2";
