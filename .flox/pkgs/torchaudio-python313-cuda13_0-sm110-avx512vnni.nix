# TorchAudio with PyTorch 2.10.0 for NVIDIA Automotive (SM110: DRIVE Thor) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda13_0-sm110-avx512vnni
#
...
let
  ...
  # GPU target: SM110 (Automotive - DRIVE Thor)
  gpuArchSM = "11.0";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm110-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm110-avx512vnni";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Automotive: DRIVE Thor)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA DRIVE Thor (SM110, Automotive) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA Automotive architecture (SM110) - DRIVE Thor
        ...
        - GPU: DRIVE Thor or other SM110 GPUs
