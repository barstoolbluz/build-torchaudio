# TorchAudio optimized for NVIDIA DRIVE Thor (SM110) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda12_8-sm110-avx512vnni
...
in
  (python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm110-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA DRIVE Thor (SM110) + AVX-512 VNNI";
      longDescription = ''
