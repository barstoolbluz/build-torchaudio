...
# Package name: torchaudio-python313-cuda12_8-sm75-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_8-sm75-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA Turing T4/RTX 2080 Ti (SM75) + AVX-512 VNNI";
      longDescription = ''
        ...
        VNNI acceleration for INT8 inference on Turing.
      '';
