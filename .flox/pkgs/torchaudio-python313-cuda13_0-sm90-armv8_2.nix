# TorchAudio with PyTorch 2.10.0 for NVIDIA H100 (Hopper) (SM90) + ARMv8.2
# Package name: torchaudio-python313-cuda13_0-sm90-armv8_2
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm90-armv8_2";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm90-armv8_2";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA H100 (Hopper) (SM90) + ARMv8.2 with PyTorch 2.10.0";
      longDescription = ''
