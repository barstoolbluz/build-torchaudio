# TorchAudio with PyTorch 2.10.0 for NVIDIA Ampere (SM86: RTX 3090, A40) + AVX-512 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm86-avx512-nomagma
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm86-avx512-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_1-sm86-avx512-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      export CFLAGS="${nixpkgs_pinned.lib.concatStringsSep " " cpuFlags} $CFLAGS"
      export MAX_JOBS=32
      echo "GPU Target: ${gpuArchSM} (Ampere: RTX 3090, A40) | CPU: AVX-512 | CUDA: 13.1"
    '';
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 3090/A40 (SM86, Ampere) + AVX-512 with PyTorch 2.10.0 (no MAGMA)";
