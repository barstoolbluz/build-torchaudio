# TorchAudio with PyTorch 2.10.0 for NVIDIA Ada Lovelace (SM89: RTX 4090) + AVX-512 VNNI (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm89-avx512vnni-nomagma
#
...
let
  ...
  # GPU target: SM89 (Ada Lovelace - RTX 4090)
  gpuArchSM = "8.9";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm89-avx512vnni-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm89-avx512vnni-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Ada Lovelace: RTX 4090)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 4090 (SM89, Ada Lovelace) + AVX-512 VNNI with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA Ada Lovelace architecture (SM89) - RTX 4090
        - CPU: x86-64 with AVX-512 VNNI instruction set
        - CUDA: 13.1 with compute capability 8.9
        - PyTorch: 2.10.0 (with all CUDA 13.1 compatibility fixes)
        - MAGMA: Disabled (using cuSOLVER for linear algebra)
        - Python: 3.13

        Hardware requirements:
        - GPU: RTX 4090, RTX 4080, L4, or other SM89 GPUs
