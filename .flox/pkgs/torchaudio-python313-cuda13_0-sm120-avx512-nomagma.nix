# TorchAudio with PyTorch 2.10.0 for NVIDIA Blackwell (SM120: RTX 5090) + AVX-512 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm120-avx512-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm120-avx512-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm120-avx512-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA RTX 5090 (SM120, Blackwell) + AVX-512 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
