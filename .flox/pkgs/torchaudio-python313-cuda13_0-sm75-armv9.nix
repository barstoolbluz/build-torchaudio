# TorchAudio with PyTorch 2.10.0 for NVIDIA T4/RTX 2080 Ti (SM75) + ARMv9
# Package name: torchaudio-python313-cuda13_0-sm75-armv9
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm75-armv9";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm75-armv9";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA T4/RTX 2080 Ti (SM75) + ARMv9 with PyTorch 2.10.0";
      longDescription = ''
