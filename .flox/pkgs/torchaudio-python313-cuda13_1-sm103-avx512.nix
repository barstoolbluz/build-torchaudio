# TorchAudio with PyTorch 2.10.0 for NVIDIA Blackwell DC (SM103: B300) + AVX-512
# Package name: torchaudio-python313-cuda13_1-sm103-avx512
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm103-avx512";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm103-avx512";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B300 (SM103, Blackwell DC) + AVX-512 with PyTorch 2.10.0";
      longDescription = ''
