# TorchAudio with PyTorch 2.10.0 for NVIDIA B200 (Blackwell) (SM103) + ARMv8.2 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm103-armv8_2-nomagma
#
...
let
  ...
  # GPU target: SM103 (NVIDIA B200 (Blackwell) - Automotive/Edge)
  gpuArchSM = "10.3";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm103-armv8_2-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm103-armv8_2-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (NVIDIA B200 (Blackwell))"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B200 (Blackwell) (SM103) + ARMv8.2 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA B200 (Blackwell) (SM103) - Automotive/Edge AI
        ...
        - GPU: NVIDIA B200 (Blackwell), Orin+ (Automotive/Embedded platforms)
        - CPU: AWS Graviton2, NVIDIA Tegra Orin, Cortex-A75+
