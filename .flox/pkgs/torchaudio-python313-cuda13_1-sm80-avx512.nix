# TorchAudio with PyTorch 2.10.0 for NVIDIA Ampere DC (SM80: A100, A30) + AVX-512
# Package name: torchaudio-python313-cuda13_1-sm80-avx512
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm80-avx512";
    patches = [];
    ninjaFlags = [ "-j32" ];
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_1-sm80-avx512";
    ...
    '';
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA A100/A30 (SM80, Ampere DC) + AVX-512 with PyTorch 2.10.0";
