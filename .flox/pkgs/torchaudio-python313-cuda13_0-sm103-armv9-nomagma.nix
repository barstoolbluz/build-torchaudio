# TorchAudio with PyTorch 2.10.0 for NVIDIA B200 (Blackwell) (SM103) + ARMv9 (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm103-armv9-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm103-armv9-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_0-sm103-armv9-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B200 (Blackwell) (SM103) + ARMv9 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
