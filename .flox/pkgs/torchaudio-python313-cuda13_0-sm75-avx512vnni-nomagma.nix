# TorchAudio with PyTorch 2.10.0 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) + AVX-512 VNNI (no MAGMA)
# Package name: torchaudio-python313-cuda13_0-sm75-avx512vnni-nomagma
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm75-avx512vnni-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override { torch = customPytorch; }).overrideAttrs (oldAttrs: {
    pname = "torchaudio-python313-cuda13_0-sm75-avx512vnni-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      export CFLAGS="${nixpkgs_pinned.lib.concatStringsSep " " cpuFlags} $CFLAGS"
      export MAX_JOBS=32
      echo "GPU Target: ${gpuArchSM} (Turing: T4, RTX 2080 Ti) | CPU: AVX-512 VNNI | CUDA: 13.0"
    '';
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA T4/RTX 2080 Ti (SM75, Turing) + AVX-512 VNNI with PyTorch 2.10.0 (no MAGMA)";
