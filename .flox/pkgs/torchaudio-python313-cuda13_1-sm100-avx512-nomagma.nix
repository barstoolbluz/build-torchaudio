# TorchAudio with PyTorch 2.10.0 for NVIDIA Blackwell DC (SM100: B100/B200) + AVX-512 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm100-avx512-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm100-avx512-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm100-avx512-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B100/B200 (SM100, Blackwell DC) + AVX-512 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
