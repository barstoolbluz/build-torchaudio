# TorchAudio with PyTorch 2.10.0 for NVIDIA Blackwell DC (SM103: B300) + AVX-512 VNNI (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm103-avx512vnni-nomagma
#
...
let
  ...
  # GPU target: SM103 (Blackwell DC - B300)
  gpuArchSM = "10.3";
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm103-avx512vnni-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm103-avx512vnni-nomagma";
    ...
    preConfigure = (oldAttrs.preConfigure or "") + ''
      ...
      echo "========================================="
      echo "GPU Target: ${gpuArchSM} (Blackwell DC: B300)"
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA B300 (SM103, Blackwell DC) + AVX-512 VNNI with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        Custom TorchAudio build with targeted optimizations:
        - GPU: NVIDIA Blackwell datacenter architecture (SM103) - B300
        - CPU: x86-64 with AVX-512 VNNI instruction set
        - CUDA: 13.1 with compute capability 10.3
