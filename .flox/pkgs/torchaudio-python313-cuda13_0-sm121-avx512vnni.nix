# TorchAudio with PyTorch 2.10.0 for NVIDIA DGX Spark (SM121) + AVX-512 VNNI
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm121-avx512vnni";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA DGX Spark (SM121) + AVX-512 VNNI with PyTorch 2.10.0";
      longDescription = ''
