# TorchAudio with PyTorch 2.10.0 for NVIDIA Hopper (SM90: H100, L40S) + AVX-512 BF16 (no MAGMA)
# Package name: torchaudio-python313-cuda13_1-sm90-avx512bf16-nomagma
#
...
let
  ...
  customPytorch = (nixpkgs_pinned.python3Packages.torch.override {
    ...
    pname = "pytorch210-for-torchaudio-sm90-avx512bf16-nomagma";
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda13_1-sm90-avx512bf16-nomagma";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA H100/L40S (SM90, Hopper) + AVX-512 BF16 with PyTorch 2.10.0 (no MAGMA)";
      longDescription = ''
        ...
        - CUDA: 13.1 with compute capability 9.0
