# TorchAudio optimized for NVIDIA DRIVE Thor (SM110) + AVX-512
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio for NVIDIA DRIVE Thor (SM110) + AVX-512";
      longDescription = ''
        ...
        Ensure pytorch-python313-cuda13_0-sm110-avx512 is installed.
      '';
