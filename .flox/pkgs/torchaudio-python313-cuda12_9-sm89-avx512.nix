# TorchAudio optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX-512
# Package name: torchaudio-python313-cuda12_9-sm89-avx512
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX-512";
