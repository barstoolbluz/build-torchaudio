# TorchAudio optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX-512 VNNI
# Package name: torchaudio-python313-cuda12_9-sm89-avx512vnni
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm89-avx512vnni";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Ada Lovelace RTX 40-series (SM89) + AVX-512 VNNI";
