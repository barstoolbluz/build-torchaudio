...
# Package name: torchaudio-python313-cuda12_9-sm103-avx512bf16
...
in
  (nixpkgs_pinned.python3Packages.torchaudio.override {
    ...
    pname = "torchaudio-python313-cuda12_9-sm103-avx512bf16";
    ...
    meta = oldAttrs.meta // {
      description = "TorchAudio optimized for NVIDIA Blackwell B300 (SM103) + AVX-512 BF16";
