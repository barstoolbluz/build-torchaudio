...
let
  ...
  # This ensures torchaudio links against the same libtorch as the published pytorch package
  pytorch_src = builtins.fetchTarball {
    url = "https://github.com/barstoolbluz/build-pytorch/archive/72b3d51.tar.gz";
  };
