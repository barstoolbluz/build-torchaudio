...
> **You are on the `pytorch-2.9` branch** — TorchAudio 2.9.1 + PyTorch 2.9.1 + CUDA 12.9.1 (58 variants)
...
| **`pytorch-2.9`** ⬅️ | **2.9.1** | **2.9.1** | **12.9.1** | **58** | **This branch** — Full coverage + SM75/SM103 (B300) |
| `pytorch-2.10` | TBD | 2.10 | 13.0 | 111 | Full matrix SM75–SM121 + ARM |
...
| **`pytorch-2.9`** ⬅️ | **2.9.1** | **2.9.1** | **12.9.1** | **9.13.0** | **3.13** | **550+** | [**`6a030d5`**](https://github.com/NixOS/nixpkgs/tree/6a030d535719c5190187c4cec156f335e95e3211) |
...
|-----------------|---------|--------------|------------------|
| **CPU-only** | AVX | `torchaudio-python313-cpu-avx` | Sandy Bridge+ maximum compatibility |
| | AVX2 | `torchaudio-python313-cpu-avx2` | Development, broad x86-64 compatibility |
...
| **SM75 (Turing)** | AVX2 | `torchaudio-python313-cuda12_9-sm75-avx2` | T4/RTX 2080 Ti + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm75-avx512` | T4/RTX 2080 Ti + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm75-avx512bf16` | T4/RTX 2080 Ti + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm75-avx512vnni` | T4/RTX 2080 Ti + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm75-armv8_2` | T4/RTX 2080 Ti + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm75-armv9` | T4/RTX 2080 Ti + ARM Grace |
| **SM80 (Ampere DC)** | AVX2 | `torchaudio-python313-cuda12_9-sm80-avx2` | A100/A30 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm80-avx512` | A100/A30 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm80-avx512bf16` | A100/A30 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm80-avx512vnni` | A100/A30 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm80-armv8_2` | A100/A30 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm80-armv9` | A100/A30 + ARM Grace |
| **SM86 (Ampere)** | AVX2 | `torchaudio-python313-cuda12_9-sm86-avx2` | RTX 3090/A40 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm86-avx512` | RTX 3090/A40 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm86-avx512bf16` | RTX 3090/A40 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm86-avx512vnni` | RTX 3090/A40 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm86-armv8_2` | RTX 3090/A40 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm86-armv9` | RTX 3090/A40 + ARM Grace |
| **SM89 (Ada)** | AVX2 | `torchaudio-python313-cuda12_9-sm89-avx2` | RTX 4090/L40 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm89-avx512` | RTX 4090/L40 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm89-avx512bf16` | RTX 4090/L40 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm89-avx512vnni` | RTX 4090/L40 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm89-armv8_2` | RTX 4090/L40 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm89-armv9` | RTX 4090/L40 + ARM Grace |
| **SM90 (Hopper)** | AVX2 | `torchaudio-python313-cuda12_9-sm90-avx2` | H100/L40S + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm90-avx512` | H100/L40S + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm90-avx512bf16` | H100/L40S + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm90-avx512vnni` | H100/L40S + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm90-armv8_2` | H100/L40S + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm90-armv9` | H100/L40S + ARM Grace |
| **SM100 (Blackwell DC)** | AVX2 | `torchaudio-python313-cuda12_9-sm100-avx2` | B100/B200 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm100-avx512` | B100/B200 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm100-avx512bf16` | B100/B200 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm100-avx512vnni` | B100/B200 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm100-armv8_2` | B100/B200 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm100-armv9` | B100/B200 + ARM Grace |
| **SM103 (Blackwell DC)** | AVX2 | `torchaudio-python313-cuda12_9-sm103-avx2` | B300 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm103-avx512` | B300 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm103-avx512bf16` | B300 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm103-avx512vnni` | B300 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm103-armv8_2` | B300 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm103-armv9` | B300 + ARM Grace |
| **SM61 (Pascal)** | AVX | `torchaudio-python313-cuda12_9-sm61-avx` | GTX 1070/1080 Ti + legacy AVX CPUs |
| | AVX2 | `torchaudio-python313-cuda12_9-sm61-avx2` | GTX 1070/1080 Ti + modern CPUs |
| **SM120 (Blackwell)** | AVX2 | `torchaudio-python313-cuda12_9-sm120-avx2` | RTX 5090 + broad CPU compatibility |
| | AVX-512 | `torchaudio-python313-cuda12_9-sm120-avx512` | RTX 5090 + general workloads |
| | AVX-512 BF16 | `torchaudio-python313-cuda12_9-sm120-avx512bf16` | RTX 5090 + BF16 training |
| | AVX-512 VNNI | `torchaudio-python313-cuda12_9-sm120-avx512vnni` | RTX 5090 + INT8 inference |
| | ARMv8.2 | `torchaudio-python313-cuda12_9-sm120-armv8_2` | RTX 5090 + ARM Graviton2 |
| | ARMv9 | `torchaudio-python313-cuda12_9-sm120-armv9` | RTX 5090 + ARM Grace |
...
| **`pytorch-2.9`** ⬅️ | 2.9.1 | 2.9.1 | 12.9.1 | SM61–SM120, SM75, SM103, CPU | 58 (this branch) |
| `pytorch-2.10` | TBD | 2.10 | 13.0 | SM75–SM121 + ARM | 111 |
...
git checkout pytorch-2.10 && flox build torchaudio-python313-cuda13_0-sm121-avx512
```
...
# Build variant
flox build torchaudio-python313-cuda12_9-sm86-avx512
```
...
# For training
flox build torchaudio-python313-cuda12_9-sm90-avx512

# For INT8 inference
flox build torchaudio-python313-cuda12_9-sm90-avx512vnni
```
...
# Build variant
flox build torchaudio-python313-cuda12_9-sm90-armv9
```
...
# The result will be in ./result-torchaudio-python313-cuda12_9-sm90-avx512/
ls -lh result-torchaudio-python313-cuda12_9-sm90-avx512/

# Test the build
./result-torchaudio-python313-cuda12_9-sm90-avx512/bin/python -c "
...
(nixpkgs_pinned.python3Packages.torchaudio.override {
  ...
  pname = "torchaudio-python313-cuda12_9-sm90-avx512";
  ...
})
```
...
│       ├── torchaudio-python313-cuda12_9-sm80-*.nix    # 6 SM80 variants
│       ├── torchaudio-python313-cuda12_9-sm86-*.nix    # 6 SM86 variants
│       ├── torchaudio-python313-cuda12_9-sm89-*.nix    # 6 SM89 variants
│       ├── torchaudio-python313-cuda12_9-sm90-*.nix    # 6 SM90 variants
│       ├── torchaudio-python313-cuda12_9-sm100-*.nix   # 6 SM100 variants
│       ├── torchaudio-python313-cuda12_9-sm103-*.nix   # 6 SM103 variants (B300)
│       └── torchaudio-python313-cuda12_9-sm120-*.nix   # 6 SM120 variants
├── README.md
├── BUILD_MATRIX.md
├── QUICKSTART.md
└── RECIPE_TEMPLATE.md
...
flox publish -o <your-org> torchaudio-python313-cuda12_9-sm90-avx512
flox publish -o <your-org> torchaudio-python313-cuda12_9-sm86-avx2
flox publish -o <your-org> torchaudio-python313-cpu-avx2

# Users install with:
flox install <your-org>/torchaudio-python313-cuda12_9-sm90-avx512
```
...
This branch pins nixpkgs to `6a030d5` which provides TorchAudio 2.9.1. If you need a different version, you'll need a different nixpkgs pin.
