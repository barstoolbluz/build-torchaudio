...
**✅ 6 variants on this branch (CUDA 12.9)**

### On `cuda-12_9` (6 variants)
- ✅ **SM103 (B300)**: 6 variants (avx2, avx512, avx512bf16, avx512vnni, armv8_2, armv9)

See `main` branch for SM80-SM120 (CUDA 12.8) and `cuda-13_0` for SM121/SM110 (CUDA 13.0).
...
1. ✅ **Branch variants created**: 6 variants (SM103, CUDA 12.9)
